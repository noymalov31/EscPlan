 ...
 */
public class AuthActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, GoogleApiClient.OnConnectionFailedListener {
    ...
    private String TAG = "AuthActivityTAG";
     ...
     */
    private void attemptLogin(boolean isNew) {
        // Reset errors.
        ...
        if (cancel) {
            ...
            showProgress(true);
            firebaseAuthWithEmail(email, password, isNew);
        }
    }
...
//            GoogleSignInAccount acct = result.getSignInAccount();
    ...
    private void firebaseAuthWithEmail(String email, String password, boolean isNew) {
        OnCompleteListener<AuthResult> compEventListener = new OnCompleteListener<AuthResult>() {
            @Override
        ...
        if (isNew) {
            auth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(this, compEventListener);
        } else {
    ...
    protected void setGooglePlusButtonText(SignInButton signInButton) {
        ...
        for (int i = 0; i < signInButton.getChildCount(); i++) {
            ...
            if (v instanceof TextView) {
                ...
                tv.setText("הכנס באמצעות חשבון גוגל");
                return;
            }
        }
    }
